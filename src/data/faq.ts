...
export const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Sí. Por seguridad y respeto a los demás asistentes, si llegas 5 minutos después de iniciada la clase no podrás ingresar.\n\nEsto garantiza un calentamiento adecuado y evita distracciones durante la sesión.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'No. Las clases están diseñadas para adaptarse a todos los niveles, desde principiantes hasta personas con experiencia.\n\nSi es tu primera vez, nuestros coaches te guiarán en cada paso para que disfrutes la experiencia desde el inicio.',
  },
  {
